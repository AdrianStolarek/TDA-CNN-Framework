...
TDA_DIR = "E:\\ZoryaDyn_Benchmarks\\CIFAR100\\processed_TDA_PURE"
RANDOM_STATE = 42
TRAINING_SAMPLES = 1000  # Odpal 500, 1000, 10000, 30000
EXPERIMENT_NAME = f"TDA_Pure_cifar100_resnet50_{TRAINING_SAMPLES}-ADRIAN"
...
def train_and_evaluate():
    ...
    INPUT_SHAPE_TDA = (INPUT_HEIGHT, INPUT_WIDTH, 3)
